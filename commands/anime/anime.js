...
name: "anime",
  ...
  run: (client, message, args) => {
    ...
    if(!args.length) {
      return message.channel.send("Podaj nazwę anime")
    }
    //DEFINE OPTIONS
    ...
    message.channel.send("Pobieranie informacji").then(msg => {
      get(option).then(body => {
       try {
        ...
        msg.delete();
         return message.channel.send("Nie można znaleźć tego anime");
       }
